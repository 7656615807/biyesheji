                ...
                <div class="panel-body">
                    ...
                    <div id="pageDiv" class="text-right">
                        <ul class="pagination pagination-sm" id="pagecontrol">
                            ...
                            <c:if test="${currentPage != 1}">
                                <li><a style='cursor:pointer;' href="DocumentActionAdmin!list.action?cp=1">首页</a></li>
                                <li><a style='cursor:pointer;' href="DocumentActionAdmin!list.action?cp=${currentPage - 1}">上一页</a></li>
                            </c:if>
                            ...
                            <c:if test="${currentPage != allRecorders}">
                            <li><a style='cursor:pointer;'  href="DocumentActionAdmin!list.action?cp=${currentPage + 1}">下一页</a></li>
                                <li><a style='cursor:pointer;'  href="DocumentActionAdmin!list.action?cp=${allRecorders}">尾页</a></li>
                            </c:if>
                            <p>
