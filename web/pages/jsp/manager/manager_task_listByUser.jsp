            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover table-striped"  id="newsTable">
                        <tr>
                            <td class="text-center"><strong>所属项目</strong> </td>
                    ...
                    <div id="pageDiv" class="text-right">
                        <c:if test="${allRecorders != 0}">
                            <ul class="pagination pagination-sm" id="pagecontrol">
                                ...
                                <c:if test="${currentPage != 1}">
                                    <li><a style='cursor:pointer;' href="TaskActionManager!listActive.action?cp=1&col=${column}&kw=${keyword}">首页</a></li>
                                    <li><a style='cursor:pointer;' href="TaskActionManager!listActive.action?cp=${currentPage - 1}&col=${column}&kw=${keyword}">上一页</a></li>
                                </c:if>
                                ...
                                <c:if test="${currentPage != allRecorders}">
                                    <li><a style='cursor:pointer;'  href="TaskActionManager!listActive.action?cp=${currentPage + 1}&col=${column}&kw=${keyword}">下一页</a></li>
                                    <li><a style='cursor:pointer;'  href="TaskActionManager!listActive.action?cp=${allRecorders}&col=${column}&kw=${keyword}">尾页</a></li>
                                </c:if>
                                <p>
