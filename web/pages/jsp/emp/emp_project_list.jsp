...
<head>
    ...
    <script type="text/javascript" src="js/emp/emp_project_update.js"></script>
                        ...
                        <c:if test="${all != null}">
                            <c:forEach items="${all}" var="a">
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/UserActionEmp!show.action?user.userid=${a.userByCreid.userid}"><span id="creidName-${a.proid}">${a.userByCreid.name}</span></a></td>
                                    <td class="text-center"><a href="/UserActionEmp!show.action?user.userid=${a.userByMgr.userid}" id="mgrHref-${a.proid}"><span id="mgrName-${a.proid}">${a.userByMgr.name}</span></a></td>
                    ...
                    <div id="pageDiv" class="text-right">
                        <c:if test="${allRecorders != 0}">
                            <ul class="pagination pagination-sm" id="pagecontrol">
                                ...
                                <c:if test="${currentPage != 1}">
                                    <li><a style='cursor:pointer;' href="ProjectActionEmp!list.action?cp=1&col=${column}&kw=${keyword}">首页</a></li>
                                    <li><a style='cursor:pointer;' href="ProjectActionEmp!list.action?cp=${currentPage - 1}&col=${column}&kw=${keyword}">上一页</a></li>
                                </c:if>
                                ...
                                <c:if test="${currentPage != allRecorders}">
                                    <li><a style='cursor:pointer;'  href="ProjectActionEmp!list.action?cp=${currentPage + 1}&col=${column}&kw=${keyword}">下一页</a></li>
                                    <li><a style='cursor:pointer;'  href="ProjectActionEmp!list.action?cp=${allRecorders}&col=${column}&kw=${keyword}">尾页</a></li>
                                </c:if>
                                <p>
