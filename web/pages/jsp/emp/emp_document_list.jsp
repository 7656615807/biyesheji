...
<head>
    ...
    <script type="text/javascript" src="js/emp/document_update.js"></script>
                ...
                <div class="panel-body">
                        ...
                        <c:if test="${all != null}">
                            <c:forEach items="${all}" var="a">
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/UserActionEmp!show.action?user.userid=${a.user.userid}"><span id="name-${a.did}">${a.user.name}</span></a></td>
                    ...
                    <div id="pageDiv" class="text-right">
                        <ul class="pagination pagination-sm" id="pagecontrol">
                            ...
                            <c:if test="${currentPage != 1}">
                                <li><a style='cursor:pointer;' href="DocumentActionEmp!list.action?cp=1">首页</a></li>
                                <li><a style='cursor:pointer;' href="DocumentActionEmp!list.action?cp=${currentPage - 1}">上一页</a></li>
                            </c:if>
                            ...
                            <c:if test="${currentPage != allRecorders}">
                            <li><a style='cursor:pointer;'  href="DocumentActionEmp!list.action?cp=${currentPage + 1}">下一页</a></li>
                                <li><a style='cursor:pointer;'  href="DocumentActionEmp!list.action?cp=${allRecorders}">尾页</a></li>
                            </c:if>
                            <p>
    ...
    <div class="modal-dialog" style="width: 800px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal"  action="<%=basePath%>DocumentActionEmp!update.action" id="myform_document_update" method="post" enctype="multipart/form-data">
                    <fieldset>
