...
<%
    ...
    String insertUrl = basePath+"UserActionAdmin!insert.action";
%>
<html>
...
<head>
    ...
    <script type="text/javascript" src="js/user_insert.js"></script>
</head>
                    ...
                    <form class="form-horizontal" action="<%=insertUrl%>" id="myform_admin_insert" method="post">
                        <fieldset>
                            ...
                            <div class="form-group" id="user.levelDiv">
                                <label class="col-md-4 control-label" for="user.level">用户角色:</label>
                                <div class="col-md-4">
