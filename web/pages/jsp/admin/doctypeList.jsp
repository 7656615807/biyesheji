        ...
        $(function() {
            $("button[id*='updateBtn-']").each(function () {
                ...
                $(this).on("click",function () {
                    ...
                    $.post("DoctypeActionAdmin!update.action",{"doctype.dtid":dtid,"doctype.title":title},
                    function (data) {
                        operateAllert(data == "true","文档类型修改成功！","文档类型修改失败！");
                    },"text");
                })
            })
            $("#insertBtn").on("click",function(){
                ...
                if(title == ""){ //现在没有选择要删除的内容
                    ...
                    var url = "/DoctypeActionAdmin!insert.action?doctype.title="+title;
                    window.location = url
                }
            });
        });
                        ...
                        <c:if test="${all != null}">
                            <c:forEach items="${all}" var="doc">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button id="updateBtn-${doc.dtid}" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>&nbsp;修改</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    </table>
                    <button class="btn btn-success" data-toggle="modal" data-target="#insertDoctype">
                        增加文档类型
                    </button>
                </div>
...
<div class="modal" id="insertDoctype">
                ...
                <form class="form-horizontal" action="" id="myform_role_insert" method="post">
                    <fieldset>
                        ...
                        <div class="form-group" id="titleDiv">
                            <label class="col-md-4 control-label" for="title">文档类型:</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-4">
                                <button type="button" id="insertBtn" class="btn btn-md btn-primary">增加类型</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
