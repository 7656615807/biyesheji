                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover table-striped"  id="newsTable">
                        <tr>
                            ...
                            <td class="text-center"><strong>用户姓名</strong> </td>
                        ...
                        <c:if test="${all != null}">
                            <c:forEach items="${all}" var="a">
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/AdminActionAdmin!show.action?user.userid=${a.userid}"><span id="name-${a.userid}">${a.name}</span></a></td>
                                    ...
                                    <td class="text-center">
                                        <select id="role.rid-${a.userid}" class="form-control" name="role.rid-${a.userid}">
                                            <c:forEach items="${allRoles}" var="role">
                                                <option value="${role.rid}" ${role.rid == a.role.rid ? "selected" : ""}>${role.title}</option>
                                            </c:forEach>
                                        </select>
                                    </td>
                    ...
                    <a class="btn btn-success"href="/AdminActionAdmin!insertPre.action"> 增加管理员</a>
                    ...
                    <div id="pageDiv" class="text-right">
                        <ul class="pagination pagination-sm" id="pagecontrol">
                            ...
                            <c:if test="${currentPage != 1}">
                                <li><a style='cursor:pointer;' href="AdminActionAdmin!list.action?cp=1">首页</a></li>
                                <li><a style='cursor:pointer;' href="AdminActionAdmin!list.action?cp=${currentPage - 1}">上一页</a></li>
                            </c:if>
                            ...
                            <c:if test="${currentPage != allRecorders}">
                            <li><a style='cursor:pointer;'  href="AdminActionAdmin!list.action?cp=${currentPage + 1}">下一页</a></li>
                                <li><a style='cursor:pointer;'  href="AdminActionAdmin!list.action?cp=${allRecorders}">尾页</a></li>
                            </c:if>
                            <p>
