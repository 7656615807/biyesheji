$(function() {
    ...
    $("button[id*='adminBtn-']").each(function () {
        ...
        $(this).on("click",function () {
            $.post("DocumentActionAdmin!updatePre.action",{"document.did":did},
                function (data) {
                console.log(data);
    ...
    $("#submitBtn").on("click",function() {
        ...
        alert(formdata);
        $.post("DocumentActionAdmin!update.action",{"document.title":title,"document.did":did,"document.content":content,"oldFile":oldFile,"file":formdata,"doctype.dtid":dtid},
            function (data) {
                $("#title-"+ did).text(name);
