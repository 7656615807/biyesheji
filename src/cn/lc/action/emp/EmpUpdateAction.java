...
@ParentPackage("root")
@Namespace("/")
@Results(value = {@Result(name = "updatePasswordVF",location = "/pages/jsp/emp/emp_password_edit.jsp"),
                    @Result(name = "emp.updatepre",location = "/pages/jsp/emp/emp_update.jsp")})
@Action("EmpUpdateAction")
public class EmpUpdateAction extends AbstractAction {
