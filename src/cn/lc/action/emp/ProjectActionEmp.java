...
@ParentPackage("root")
@Namespace(value="/")
@Results(value = {@Result(name = "project.list",location = "/pages/jsp/emp/emp_project_list.jsp")})
...
public class ProjectActionEmp extends AbstractAction {
    ...
    public String list(){
        try{
            ...
            super.handleSplit(map.get("projectCount"),"emp.project.list.action",null,null);
