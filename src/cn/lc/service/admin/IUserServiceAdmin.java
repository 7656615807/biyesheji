...
public interface IUserServiceAdmin {
     ...
     *      <li>如果用户不存在就进行保存，但是级别根据你的角色来决定</li>
     ...
     *     <li>调用IUserDao.findById()取得当前用户的信息</li>
     * @param userid
     * @return
     * @throws Exception
     */
    ...
    /**
     * 用户数据的批量锁定操作，如果没有数据则返回false，如果有数据则调用IUserDao.doRemoveBatch()方法
     * @param ids 包含了所有要锁定的用户编号
     * @return 删除成功返回true 否则返回false
     * @throws Exception
     */
    boolean updateLock(Set<String> ids,int lock) throws Exception;
    ...
    /**
     * 修改用户的密码操作，调用IUserDao.doUpdatePassword()
