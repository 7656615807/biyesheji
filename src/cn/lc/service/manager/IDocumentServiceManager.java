...
public interface IDocumentServiceManager {
     ...
     * @throws Exception
     */
    boolean update(Document vo,String userid) throws Exception;
     ...
     * @throws Exception
     */
    boolean delete(Set<Integer> ids,String userid) throws Exception;
     ...
     * @throws Exception
     */
    Map<String, Object> listByUser(String userid, int currentPage, int lineSize, String column, String keyWord) throws Exception;

    Document show(int did)throws Exception;
}
